...
//     // Form states
//     const [healthId, setHealthId] = useState("14-1234-5678-9012") // Default for testing
//     const [symptoms, setSymptoms] = useState("")
//     const [diagnosis, setDiagnosis] = useState("")
//     const [disease Status, setDiseaseStatus] = useState("ongoing")
...
//         setLoading(true)
//         try {
//             const response = await api.patient.getByHealthId(healthId)
//             setPatient(response.patient)

//             // Load patient history
//             const historyResponse = await api.patient.getHistory(response.patient.id)

//             // Set latest medical record if exists
//             if (historyResponse.history.medical_records && historyResponse.history.medical_records.length > 0) {
//                 const latestRecord = historyResponse.history.medical_records[0]
...
//             // Set prescriptions
//             if (historyResponse.history.prescriptions) {
//                 setPrescriptions(historyResponse.history.prescriptions.map(p => ({
//                     id: p.id,
...
//             // Set latest vitals
//             if (historyResponse.history.vitals && historyResponse.history.vitals.length > 0) {
//                 const latestVitals = historyResponse.history.vitals[0]
...
//             toast({ title: "Success", description: `Loaded patient: ${response.patient.name}` })
//         } catch (error) {
...
//                 blood_pressure_systolic: parseInt(vitalsSystolic) || null,
//                 blood_pressure_diastolic: parseInt(vitalsDiastolic) || null,
//                 temperature: parseFloat(temperature) || null,
//                 heart_rate: parseInt(heartRate) || null,
//                 oxygen_saturation: parseInt(o2Saturation) || null
//             }

//             const response = await api.vitals.record(vitalsData)
...
//                 duration: p.duration,
//                 instructions: p.instructions
//             })).filter(p => p.medicine_name) // Only save non-empty prescriptions
...
//                                     <Input value={vitalsSystolic} onChange={(e) => setVitalsSystolic(e.target.value)} placeholder="120" />
//                                 </div>
//                                 <div>
//                                     <Label>BP Diastolic</Label>
//                                     <Input value={vitalsDiastolic} onChange={(e) => setVitalsDiastolic(e.target.value)} placeholder="80" />
//                                 </div>
//                                 <div>
...
//                                     <Input value={heartRate} onChange={(e) => setHeartRate(e.target.value)} placeholder="72" />
//                                 </div>
//                                 <div>
//                                     <Label>O2 Saturation</Label>
//                                     <Input value={o2Saturation} onChange={(e) => setO2Saturation(e.target.value)} placeholder="98" />
//                                 </div>
//                             </div>
